  ...
  const exportFormats = [
    {
      ...
      color: "bg-green-100/20 text-green-700",
    },
    {
      id: "excel",
      name: "Excel Export",
      ...
      icon: FileSpreadsheet,
      color: "bg-blue-100/20 text-blue-700",
    },
    {
      id: "json",
      name: "JSON Export",
      ...
      icon: FileJson,
      color: "bg-yellow-100/20 text-yellow-700",
    },
    {
      id: "pdf",
      name: "PDF Export",
      ...
      icon: File,
      color: "bg-red-100/20 text-red-700",
    },
    {
      id: "database",
      name: "Database Dump",
      ...
      icon: Database,
      color: "bg-purple-100/20 text-purple-700",
    },
  ]
